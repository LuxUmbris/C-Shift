...
private:
  ...
  std::unordered_map<std::string, TokenType> keyword_lookup = {
      ...
      {"voided", TokenType::KEYWORD},
      {"raw", TokenType::KEYWORD},
      // Canonical integer/float types
      {"int8", TokenType::KEYWORD},
      {"int16", TokenType::KEYWORD},
      {"int32", TokenType::KEYWORD},
      {"int64", TokenType::KEYWORD},
      {"uint8", TokenType::KEYWORD},
      {"uint16", TokenType::KEYWORD},
      {"uint32", TokenType::KEYWORD},
      {"uint64", TokenType::KEYWORD},
      {"float32", TokenType::KEYWORD},
      {"float64", TokenType::KEYWORD},
      {"char", TokenType::KEYWORD},
      {"bool", TokenType::KEYWORD},
      {"string", TokenType::KEYWORD},
      // Short aliases (i8/u8/i32/u32 etc.) — identical semantics
      {"i8", TokenType::KEYWORD},
      {"u8", TokenType::KEYWORD},
      {"i16", TokenType::KEYWORD},
      {"u16", TokenType::KEYWORD},
      {"i32", TokenType::KEYWORD},
      {"u32", TokenType::KEYWORD},
      {"i64", TokenType::KEYWORD},
      {"u64", TokenType::KEYWORD},
      {"f32", TokenType::KEYWORD},
      {"f64", TokenType::KEYWORD},
      {"byte", TokenType::KEYWORD}, // alias for u8
      {"true", TokenType::KEYWORD},
      {"false", TokenType::KEYWORD},
      {"import", TokenType::KEYWORD},
      {"entry", TokenType::KEYWORD},
